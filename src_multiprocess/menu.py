...
def draw_extraInfo(screen: pygame.Surface, local_ego_motion: egomotion_t, vehicle_group, scanID):
    # display car info
    font = pygame.font.Font(pygame.font.get_default_font(), 16)
    text = font.render('Speed: ' + str(local_ego_motion.Speed), True, white)
