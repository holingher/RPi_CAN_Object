...
def process_tx(can_bus_radar:can.BusABC, can_bus_car:can.BusABC):
    ...
    if delta >= MSG_CYCLE_TIME:  # Check if 60ms has passed
        #print(f"current_time: {current_time:.2f} ms")
        #print(f"previous_time: {previous_time * 1000:.2f} ms")
        ...
        previous_time = time.time()  # Update the previous time
